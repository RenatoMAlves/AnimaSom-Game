var playState = {
    ...
    create: function(){
        ...
        function initial(){
            game.add.tween(groupCidade.children[0].scale).to( { x: 0.2, y: 0.2 }, 1000, Phaser.Easing.Elastic.In, true);
            game.add.tween(cachorro.scale).to( { x: 0.5, y: 0.1 }, 1000, Phaser.Easing.Elastic.In, true);
            groupCidade.children[1].visible = false;
            groupCidade.children[2].visible = false;
            gato.visible = false;
            passaro.visible = false;
