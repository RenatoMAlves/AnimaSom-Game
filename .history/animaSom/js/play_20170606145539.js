var playState = {
    ...
    create: function(){
        ...
        function start(){
            ...
            cachorro.y -= 70;
            game.add.tween(groupCidade.children[0].scale).to( { x: 2, y: 2 }, 2000, Phaser.Easing.Elastic.Out, true);
            game.add.tween(cachorro.scale).to( { x: 1, y: 1 }, 2000, Phaser.Easing.Elastic.Out, true);
        }
