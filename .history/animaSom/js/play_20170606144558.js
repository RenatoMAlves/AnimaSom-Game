var playState = {
    ...
    create: function(){
        ...
        function start(){
            ...
            cachorro.y -= 70;
            game.add.tween(groupCidade.children[0].scale).to( { x: 2, y: 2 }, 1500, Phaser.Easing.Linear.Out, true);
            game.add.tween(cachorro.scale).to( { x: 1, y: 1 }, 1500, Phaser.Easing.Linear.Out, true);
        }

        function initial(){
            game.add.tween(groupCidade.children[0].scale).to( { x: 1, y: 1 }, 500, Phaser.Easing.Linear.In, true);
