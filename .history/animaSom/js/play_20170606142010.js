var playState = {
    ...
    create: function(){
        ...
        function start(){
            ...
            console.log(groupCidade.children[0]);
            console.log(cachorro);
            tween1 = game.add.tween(groupCidade.children[0].scale).to( { x: 1, y: 1 }, 1000, Phaser.Easing.Elastic.Out, true);
            // tween = game.add.tween(cachorro.scale).to( { x: 1, y: 1 }, 1000, Phaser.Easing.Elastic.Out, true);
        }
