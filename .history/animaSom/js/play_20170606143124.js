var playState = {
    ...
    create: function(){
        ...
        function initial(){
            game.add.tween(groupCidade.children[0].scale).to( { x: 0.2, y: 0.2 }, 500, Phaser.Easing.Elastic.Out, true);
            game.add.tween(cachorro.scale).to( { x: 0.1, y: 0.1 }, 500, Phaser.Easing.Elastic.Out, true);
            groupCidade.children[1].visible = false;
            groupCidade.children[2].visible = false;
            gato.visible = false;
            passaro.visible = false;
