var playState = {
    ...
    create: function(){
        ...
        function initial(){
            ...
            game.add.tween(groupCidade.children[2]).to( { alpha: 1 }, 1500, Phaser.Easing.Linear.None, true);
            game.add.tween(gato).to( { alpha: 1 }, 1500, Phaser.Easing.Linear.None, true);
            game.add.tween(passaro).to( { alpha: 1 }, 1500, Phaser.Easing.Linear.None, true);
            game.add.tween(background).to( { alpha: 1 }, 1500, Phaser.Easing.Linear.None, true);
